...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            deletelStr: "Удалить",
            doneStr: "Загружено",
            multiDragErrorStr: "Мультизагрузка запрещена",
            extErrorStr: "Тип файла запрещен: ",
            duplicateErrorStr: "is not allowed. File already exists.",
            sizeErrorStr: "Файл слишком большого размера: ",
            uploadErrorStr: "Загрузка не разрешена",
            maxFileCountErrorStr: " Слишком большое количество файлов:",
            downloadStr: "Скачать",
